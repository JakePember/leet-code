...
import binary_search.LargestNumberAtLeastTwiceOfOthers
import spock.lang.Specification

class LargestNumberAtLeastTwiceOfOthersSpec extends Specification {
    def "Find whether the largest element in the array is at least twice as much as every other number in the array."() {
